...
from .serializers import XeSerializer, Nhan_vienSerializer, Nhan_vien_xeSerializer, CapnhatSerializer, So_dien_thoai_guiSerializer, So_dien_thoai_nhanSerializer, Tin_nhanSerializer, Muc_nuocSerializer
